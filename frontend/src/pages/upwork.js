 ...
 * Upwork Detail Page
 * ==================
 * Detailed view for the Upwork scraper module in Black & Yellow Theme.
 */
    ...
    <div className="container-main" style={{ padding: '40px 24px 80px' }}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '8px' }}>
          ...
          <div>
            <h1 style={{ fontSize: '1.8rem', fontWeight: 800 }}>Upwork Jobs</h1>
            <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>
              Scrape AI, SaaS, and development job postings from Upwork
            </p>
          </div>
        </div>
      </motion.div>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.8rem' }}>
            <thead>
              <tr style={{ borderBottom: '1px solid rgba(255,215,0,0.1)' }}>
                {['Project Title', 'Budget', 'Client Location', 'Posted Date', 'Keyword'].map((h) => (
                  <th key={h} style={{
              ...
              {data.length === 0 ? (
                ...
                data.map((row, idx) => (
                  ...
                  >
                    ...
                    <td style={{ padding: '12px 16px', whiteSpace: 'nowrap', color: '#FFD700', fontWeight: 600 }}>
                      {row['Budget'] || 'N/A'}
                    </td>
                    <td style={{ padding: '12px 16px', color: 'var(--text-secondary)' }}>
                      {row['Client Location'] || 'N/A'}
                    </td>
...
UpworkPage.pageTitle = 'DataScrap — Upwork Jobs';
